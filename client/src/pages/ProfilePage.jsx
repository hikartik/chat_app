...
const ProfilePage = () => {
  ...
  // If authUser isn’t loaded yet, don’t render the form
  if (!authUser) {
    return null; // or some <LoadingSpinner /> if you prefer
  }

  // Initialize name/bio safely, in case authUser was null on first render
  ...
  return (
    <div className="min-h-screen bg-cover bg-no-repeat flex items-center justify-center">
      <div
        className="
          w-5/6 max-w-2xl
          backdrop-blur-2xl text-gray-300
